...
class RunnerConfig(Config):
    ...
    def parse_from_yaml_config(yaml_config, **kwargs):
        ...
        return RunnerConfig(data_config=data_config,
    ...
    def update_config(self):
        ...
        log_folder = create_folder(self.base_config.base_dir,
                                   model_folder_name)
        ...
        self.base_config.specs['saved_log_dir'] = os.path.join(
            log_folder, 'log')
        ...
        py_assert(
            is_torch_available() if use_torch else is_tf_available(),
            ValueError,
    ...
    def copy(self):
        ...
        """
        return RunnerConfig(base_config=copy.deepcopy(self.base_config),
